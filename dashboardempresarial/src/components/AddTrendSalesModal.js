...
import { addTrendSales } from "../services/TrendSalesService";
import { AiOutlineClose } from 'react-icons/ai';

const AddTrendSalesModal = (props) =>{
                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="bg-white w-full md:w-1/2 p-6 rounded-lg relative">
                        <h2 className="text-lg font-semibold mb-4 text-black">
                            Preencha os dados do Desempenho das Tendências de Vendas
                        </h2>
                        <button
...
export default AddTrendSalesModal;