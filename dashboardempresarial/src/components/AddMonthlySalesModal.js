...
import { addMonthlySales } from "../services/MonthlySalesService";
import { AiOutlineClose } from 'react-icons/ai';

const AddMonthlySalesModal = (props) =>{
                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="bg-white w-full md:w-1/2 p-6 rounded-lg relative">
                        <h2 className="text-lg font-semibold mb-4 text-black">
                            Preencha os dados do Desempenho das Vendas Mensais
                        </h2>
                        <button
...
export default AddMonthlySalesModal;